function [Sigtdraw,log_lik3,sigt,Wdraw,W_sse] = mcmc_draw_sigma(statedraw,Wdraw,yss,Zs,m_s,u2_s,M,t,sigma_prmean,sigma_prvar,W_prmean,W_prvar)
...
sse_2       = Sigttemp(1:t-1,:)'*Sigttemp(1:t-1,:);
W_sse = sse_2;
% sse_2 = zeros(M,M);
% for i = 1:t-1
