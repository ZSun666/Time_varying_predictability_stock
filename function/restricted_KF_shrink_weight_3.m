function[m_restricted,m_update,p_restricted] = restricted_KF_shrink_weight_3(Y,X,m_last,P_last,Q,R)
    MK = size(m_last,1);
%     Y_augment = [Y;1];
...
%     H_full = [H,-H;-H,H]; f_full = [f,-f];
    ...
    m_restricted = quadprog(H,f,A,b,Aeq,beq,[],[],m_update,opts);
